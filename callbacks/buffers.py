...
class ReplayBuffer:
    ...
    def add(self,
        ...
        if self.count + n_additional < self.size:
            ...
            self.buffer['next_state'][self.count:self.count + n_additional] = next_state
            ...
            self.buffer['next_state'] = np.roll(self.buffer['next_state'], n_roll, axis=0)
    ...
    def sample(self,
        ...
        next_state = torch.tensor(self.buffer['next_state'][batch_idx], dtype=torch.float32)
