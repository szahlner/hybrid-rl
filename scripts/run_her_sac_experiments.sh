...
python train_her_sac.py --env-name ShadowHandBlock-v1 --seed 123 --n-epochs 3750 --n-cycles 40 --alpah 0.01 --model-based --model-training-freq 1000
python train_her_sac.py --env-name ShadowHandBlock-v1 --seed 1234 --n-epochs 3750 --n-cycles 40 --alpah 0.01 --model-based --model-training-freq 1000
python train_her_sac.py --env-name ShadowHandBlock-v1 --seed 12345 --n-epochs 3750 --n-cycles 40 --alpah 0.01 --model-based --model-training-freq 1000
