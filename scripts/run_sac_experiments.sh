...
# python train_sac.py --env-name InvertedPendulum-v2 --seed 123 --max-timesteps 100000 --automatic-entropy-tuning --target-entropy -0.05 --n-batches 2
...
# python train_sac.py --env-name InvertedDoublePendulum-v2 --seed 123 --max-timesteps 100000 --automatic-entropy-tuning --target-entropy -0.5 --n-batches 2
