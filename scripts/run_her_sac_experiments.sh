...
mpirun -np 1 --allow-run-as-root python train_her_sac.py --env-name ShadowHandBlock-v1 --seed 123 --n-epochs 1000 --n-cycles 40 --alpha 0.01 --model-based --model-max-rollout-timesteps 1
